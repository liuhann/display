...
export default class ReactRenderer extends Renderer {
  ...
  invoke (method, args) {
    ...
    if (this.renderRef && this.renderRef[method] && typeof this.renderRef[method] === 'function') {
      return this.renderRef[method](...(args || []))
    } else {
  ...
  updateProps (props) {
    ...
    if (this.renderRef && typeof this.renderRef.updateProps === 'function') {
      this.renderRef.updateProps(props)
    } else {
      ReactDOM.render(React.createElement(this.JSXComponent, this.props), this.el)
    }
  }
